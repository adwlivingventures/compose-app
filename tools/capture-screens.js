...
const SHOTS = [
  ...
  { name: '38-commit', ...onboard('commit') },
  { name: '39-building-plan', ...onboard('building-plan'), delay: 600 },
  { name: '40-plan-promise', ...onboard('plan-promise') },
  { name: '41-your-plan', ...onboard('your-plan') },
  { name: '42-all-included', ...onboard('all-included') },
  { name: '43-invest-yourself', ...onboard('invest-yourself') },
  { name: '44-paywall-top', ...onboard('paywall') },
  { name: '44b-paywall-scrolled', ...onboard('paywall'), scrollInner: true },
  { name: '45-paywall-dismiss', ...onboard('paywall', { '@paywall_dismissed': true }) },
  { name: '46-day-zero', ...onboard('day-zero') },
  { name: '46b-telemetry-consent', storage: {}, url: '/consent' },
  { name: '47-discretion-setup', storage: {}, url: '/discretion?intro=1' },
