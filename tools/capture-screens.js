...
const SHOTS = [
  ...
  { name: '29-card-novelty-loop', ...onboard('card-novelty-loop') },
  { name: '30-card-dmn', ...onboard('card-dmn') },
  { name: '31-card-bandaids', ...onboard('card-bandaids') },
  { name: '32-card-spectatoring', ...onboard('card-spectatoring') },
  { name: '33-turn-welcome', ...onboard('turn-welcome') },
  { name: '34-compose-welcome', ...onboard('compose-welcome') },
  { name: '35-hopeful-arc-1', ...onboard('hopeful-arc') },
  { name: '35b-hopeful-arc-privacy', ...onboard('hopeful-arc'), clicks: ['Continue', 'Continue', 'Continue', 'Continue'] },
  { name: '36-expert-consensus', ...onboard('expert-consensus') },
  { name: '37-field-reports', ...onboard('field-reports') },
  { name: '38-diverging-graph', ...onboard('diverging-graph'), delay: 2500 },
  { name: '39-goals', ...onboard('goals') },
  { name: '40-commit', ...onboard('commit') },
  { name: '41-building-plan', ...onboard('building-plan'), delay: 600 },
  { name: '42-plan-promise', ...onboard('plan-promise') },
  { name: '43-your-plan', ...onboard('your-plan') },
  { name: '44-all-included', ...onboard('all-included') },
  { name: '45-invest-yourself', ...onboard('invest-yourself') },
  { name: '46-paywall-top', ...onboard('paywall') },
  { name: '46b-paywall-scrolled', ...onboard('paywall'), scrollInner: true },
  { name: '47-paywall-dismiss', ...onboard('paywall', { '@paywall_dismissed': true }) },
  { name: '48-day-zero', ...onboard('day-zero') },
  { name: '48b-telemetry-consent', storage: {}, url: '/consent' },
  { name: '49-discretion-setup', storage: {}, url: '/discretion?intro=1' },
